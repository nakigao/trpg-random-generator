...
<div class="container">
    <div class="page-header">
        ...
        <ul class="nav nav-pills">
            ...
            <li role="presentation" class="{% if router.getControllerName() == 'real' %}active{% else %}{% endif %}"><a href="real">REAL</a></li>
            <li role="presentation" class="{% if router.getControllerName() == 'fantasy'%}active{% else %}{% endif %}"><a href="fantasy">FANTASY</a></li>
            <li role="presentation" class="{% if router.getControllerName() == 'fantasy_sword_world_2'%}active{% else %}{% endif %}"><a href="fantasy_sword_world_2">SW2.0</a></li>
        </ul>
    </div>
    <div>
        {{ content() }}
